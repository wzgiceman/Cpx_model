package com.prog.zhigangwei.cpx_model.youtube.comment.childComment.childComment
 ...
 * Date:    2019/2/12
 */
class YouTubeChildCommentAdapter(context: Context) : RecyclerArrayAdapter<YouTubeCommentResult.ContentBean.CommentsBean>(context) {
